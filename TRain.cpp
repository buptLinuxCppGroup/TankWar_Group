...
TRain::TRain(IrrlichtDevice *device, scene::ISceneManager* smgr, video::IVideoDriver* mDriver, double x1, double y1, double z1)
{
	x = x1;
	y = y1;
	z = z1;
...
void TRain::set(double x1, double y1, double z1)
{
	x = x1;
	y = y1;
	z = z1;
