...
f32  irr::scene::CWindGenerator::getStrength()  { return Strength; }
void irr::scene::CWindGenerator::setRegularity  ( f32 regularity ) { Regularity = regularity; }
f32  irr::scene::CWindGenerator::getRegularity(){ return Regularity; }
...
core::vector2df irr::scene::CWindGenerator::getWind( const core::vector3df& position, u32 timeMs )
{
...
irr::scene::IWindGenerator* createWindGenerator( f32 strength, f32 regularity )
{
	irr::scene::CWindGenerator* wind = new irr::scene::CWindGenerator();
